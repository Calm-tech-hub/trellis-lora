...
__attributes = {
    ...
    'SparseStructureLatentViews': 'sparse_structure_latent_views',
    'ImageConditionedSparseStructureLatentViews': 'sparse_structure_latent_views',
...
if __name__ == '__main__':
    ...
    from .sparse_structure_latent_views import (
        SparseStructureLatentViews,
        ImageConditionedSparseStructureLatentViews,
    )
